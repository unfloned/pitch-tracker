...
import { createEventSender, type EventSender } from '../../shared/ipc-events';
import { startIdleWatcher, type IdleWatcher } from './services/imap-idle.service';
import { syncInbox } from './services/sync.service';
